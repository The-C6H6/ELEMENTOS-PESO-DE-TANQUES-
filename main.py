...
from UI import (
    dropdown_material,
    dropdown_tanque,
    dropdown_placa_horizontal_vertical,
    distribucion_pagina,
    dropdown_cabezal,
    dropdown_eficiencia_soldadura,
    dropdown_norma,
    dropdown_fondo,
)
from UI import (
...
def main(page: ft.Page):
    ...
    # Estaticos
    elementos_UI["imagen_placa"] = ft.Image(
        src="./assets/placa horizontal.png", width=300, height=300
    )
    elementos_UI["imagen_tanque"] = ft.Image(
        src="./assets/tanque.png", width=275, height=360
    )
    elementos_UI["pagina"] = page
    # Dinámicos

    elementos_UI["dropdown_Placa horizontal o vertical"] = (
        dropdown_placa_horizontal_vertical(elementos_UI, variables_dinamicas)
    )
    ...
    elementos_UI["dropdown_tipo_fondo"] = dropdown_fondo(
        variables_dinamicas, elementos_UI
    )

    elementos_UI["dropdown_eficiencia_soldadura"] = dropdown_eficiencia_soldadura(
        variables_dinamicas
    )
    ...
    elementos_UI["dropdown_Tipo_de_tanque"] = dropdown_tanque(
        elementos_UI, variables_dinamicas
    )
    elementos_UI["boton_calcular"] = boton_calcular(elementos_UI, variables_dinamicas)
